...
import { SvgKetcherEditor } from "./editor/SvgKetcherEditor";
...
type FigureCandidate = Record<string, unknown> & {
  ...
  publication_caption_text?: string;
  caption_quality?: { status?: string };
